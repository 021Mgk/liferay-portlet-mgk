...
package com.mgk.portlet.service.persistence.impl;
...
import com.mgk.portlet.exception.NoSuchPersonException;
import com.mgk.portlet.model.Person;
import com.mgk.portlet.model.impl.PersonImpl;
import com.mgk.portlet.model.impl.PersonModelImpl;
import com.mgk.portlet.service.persistence.PersonPersistence;
import com.mgk.portlet.service.persistence.impl.constants.mgkPersistenceConstants;
...
public class PersonPersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, PersonImpl.class, primaryKey);
		}
	}
	...
	public Person updateImpl(Person person) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {personModelImpl.getNationalCode()};

			finderCache.removeResult(_finderPathCountByNationalCode, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByNationalCode, args);
			...
			if ((personModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByNationalCode.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					personModelImpl.getOriginalNationalCode()
				};
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByNationalCode = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, PersonImpl.class,
		...
		_finderPathWithoutPaginationFindByNationalCode = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, PersonImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByNationalCode",
			new String[] {String.class.getName()},
			PersonModelImpl.NATIONALCODE_COLUMN_BITMASK);

		_finderPathCountByNationalCode = new FinderPath(
			entityCacheEnabled, finderCacheEnabled, Long.class,
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.mgk.portlet.model.Person"),
			true);
	}
